							...
							<div class="email-compose-fields">
								<form action="backend/action-form-konsultasi-compose-admin.php" method="post" id="konsul-compose">
									<div class="form-group row">
												...
												<?php
													...
													if (mysqli_num_rows($result_user) > 0) {
														...
														while ($row_user = mysqli_fetch_assoc($result_user)) {
															echo '<option value="' . $row_user['nim'] . '">' . $row_user['nama'] . '</option>';
														}
													}else{
										...
										<label for="judul" class="col-form-label col-md-1">Topik</label>
										<div class="col-md-11">
											<input type="text" class="form-control" id="judul" name="judul" required>
										</div>

										<label for="pesan" class="col-form-label col-md-1">Isi Pesan</label>
										<div class="col-md-11">
											<textarea id="pesan" name="pesan" rows="15" style="width:100%; padding:10px 15px; border-color:#e4e8eb; border-radius: .25rem .25rem; color:#37424D;" required></textarea>
										</div>
									</div>
								</form>
							</div>
