...
<head>
  ...
  <link href="assetsLanding/vendor/remixicon/remixicon.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Brave</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="assetsLanding/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
            Brave adalah platform yang bertujuan untuk melawan kekerasan seksual dengan memberikan jalur pelaporan yang aman dan terpercaya bagi para korban. Dengan adanya platform ini, kita dapat bersama-sama melawan kekerasan seksual dan memberikan dukungan kepada para korban.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Melawan kekerasan seksual dengan memberikan jalur pelaporan yang aman dan terpercaya bagi para korban.</li>
              <li><i class="ri-check-double-line"></i> Menyediakan berbagai sumber daya dan dukungan untuk para korban kekerasan seksual.</li>
              <li><i class="ri-check-double-line"></i> Bersama-sama memberikan dukungan dan bantuan kepada para korban kekerasan seksual.</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <p>
            Melalui platform Brave, para korban kekerasan seksual dapat melaporkan tindakan kekerasan yang mereka alami dengan aman dan terpercaya. Selain itu, platform ini juga menyediakan berbagai sumber daya dan dukungan untuk para korban kekerasan seksual.
            </p>
            <a href="login.php" class="btn-learn-more">Masuk ke Aplikasi</a>
          </div>
        </div>
	...
	<section id="more-services" class="more-services">
		...
		while ($row = mysqli_fetch_assoc($result_user)) {
			...
			<div class="card" style="background-image: url('<?php echo $row['foto']; ?>');" data-aos="fade-up" data-aos-delay="100">
				<div class="card-body">
				<h5 class="card-title"><a href=""><?php echo $row['judul']; ?></a></h5>
				<p class="card-text"><?php echo $row['penulis']; ?></p>
				<div class="read-more"><a href="<?php echo $row['link']; ?>"><i class="bi bi-arrow-right"></i> Read More</a></div>
				</div>
			</div>
			</div>
		<?php
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="assetsLanding/img/team/team-1.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="assetsLanding/img/team/team-2.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="assetsLanding/img/team/team-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="assetsLanding/img/team/team-4.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="info">
              <div>
                ...
                <p>Jl. Dr. Setiabudi No.229, Isola, Kec. Sukasari, Kota Bandung, Jawa Barat 40154</p>
              </div>
        ...
        <div class="col-lg-6">
          <nav class="footer-links text-lg-right text-center pt-2 pt-lg-0">
			<a class="scrollto" href="#hero">Home</a>
          	<a class="scrollto" href="#about">Tentang</a>
          	<a class="scrollto" href="#services">Artikel</a>
          	<a class="scrollto " href="#team">Tim Kami</a>
		  	<a class="scrollto" href="#contact">Hubungi Kami</a>
          	<a class="scrollto" href="login.php">Login</a>
          </nav>
        </div>
      </div>
    </div>
