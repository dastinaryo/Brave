						...
						<div class="page-content mail-content">
							...
							<div class="inbox-body" style="padding-top:0;">
								...
								<?php
									...
									$sql = "SELECT * FROM konsultasi WHERE pengirim='$login_id' ORDER BY tgl_konsultasi DESC";
									...
									if (mysqli_num_rows($result) > 0) {
										...
										while ($row = mysqli_fetch_assoc($result)) {
											$nim= $row['penerima'];
											$sql_user = "SELECT * FROM users WHERE nim='$nim'";
												...
												echo '
													<div class="email-list-item">
														<div class="email-list-detail" data-toggle="modal" data-target="#konsultasi-' . $row['id_konsul'] . '">
															...
															<span class="from"> Kepada : ' .  $row_users['nama'] . '</span>
